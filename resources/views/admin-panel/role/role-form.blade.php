...
@section('title')
{{ __('Roles') }} {{ __( ucfirst(request()->segment(count(request()->segments())))) }}
@endsection
                                ...
                                <div class="d-flex align-items-baseline flex-wrap mr-5">
                                    ...
                                    <ul
                                        ...
                                        <li class="breadcrumb-item text-muted">
                                            <a href="{{ route('role.index', [ app()->getlocale() ]) }}"
                                                class="text-muted">{{ __('Roles') }}</a>
                                        </li>
                    ...
                    <div class="d-flex flex-column-fluid">
                        ...
                        <div class="container">
                            ...
                            <div class="card card-custom">
                                ...
                                @if($role->id)
                                <form
                                    action="{{ route(Request::segment(3) . '.update', [ app()->getlocale(), $role->id ] ) }}"
                                    ...
                                    <form
                                        ...
                                        <div class="card-body">
                                            <div class="container">
                                                <div class="row">
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                name="name"
                                                                placeholder="{{ __('Name') }}"
                                                                value="{{ $role->name ?? '' }}{{ request()->segment(count(request()->segments())) == 'create' ? old('name') : '' }}" />
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                value="{{ $role->guard_name ?? '' }}{{ request()->segment(count(request()->segments())) == 'create' ? old('name') : '' }}" />
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            ...
                                                            @foreach ($permissions as $key => $permission)
                                                                <div>
                                                                    <input type="checkbox" name="permissions[]" value="{{ $permission->name }}" placeholder="{{ __('Permissions') }}" />
                                                                    {{ $permission->name }}
                                                                </div>    
                                                            @endforeach 
                                                        </div>
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            <label>{{ __('Active') }} {{ __('Permissions') }}</label>

                                                            <br>

                                                            @foreach ($role->getAllPermissions() as $key => $activePermission)
                                                                <div>
                                                                    <input type="checkbox" value="{{ $activePermission->name }}" placeholder="{{ __('Permissions') }}" checked />
                                        ...
                                        <div class="card-footer d-flex justify-content-between">
                                            ...
                                            <button type="submit"
                                                title="{{ $role->id ? __('Edit') : __('Create') }}"
                                                class="btn {{ $role->id ? 'btn-warning' : 'btn-primary' }} font-weight-bolder">
                                                <span class="svg-icon svg-icon-md">
                                                    @if($role->id)
                                                    <span
                                                        class="svg-icon svg-icon-md {{ $role->id ? 'svg-icon-dark' : '' }}">
                                                ...
                                                <span class="{{ $role->id ? 'text-dark' : '' }}">
                                                    {{ $role->id ? __('Edit') : __('Create') }}
                                                </span>
                                            </button>
                                        </div>
                                    </form>
