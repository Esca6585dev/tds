...
<div class="section__profile__body">
    ...
    <div class="section__application__form">
                ...
                <div class="row">
                    <div class="col d-flex">
                        ...
                        <div class="form__profile__phone__number">
                            ...
                            <select name="bolum" class="upload__btn" onchange="changeDescriptionRedirectUrl(event)" id="bolum">
        ...
        <div class="section__container__application__wrapper">
            <div id="section_description" class="section_application_description">
