...
@section('title')
{{ __('Standards') }} {{ __( ucfirst(request()->segment(count(request()->segments())))) }}
@endsection
                                ...
                                <div class="d-flex align-items-baseline flex-wrap mr-5">
                                    ...
                                    <ul
                                        ...
                                        <li class="breadcrumb-item text-muted">
                                            <a href="{{ route('standart.index', [ app()->getlocale() ]) }}"
                                                class="text-muted">{{ __('Standards') }}</a>
                                        </li>
                            ...
                            <div class="card card-custom">
                                <div class="card-header flex-wrap py-5">
                                    <div class="card-title">
                                        <h3 class="card-label">{{ __('Standards') }}
                                ...
                                @if($standart->id)
                                <form
                                    action="{{ route(Request::segment(3) . '.update', [ app()->getlocale(), $standart->id ] ) }}"
                                    ...
                                    <form
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                name="number"
                                                                placeholder="TDS №"
                                                                value="{{ $standart->number ?? '' }}{{ request()->segment(count(request()->segments())) == 'create' ? old('number') : '' }}" />

                                                            @error('number')
                                                            <div class="fv-plugins-message-container invalid-feedback">
                                                                <div data-field="number" data-validator="notEmpty">
                                                                    {{ $message }}
                                                                </div>
                                                            </div>
                                                            @enderror
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                value="{{ $standart->{ 'name_' . $lang } ?? '' }}{{ request()->segment(count(request()->segments())) == 'create' ? old('name_' . $lang) : '' }}" />
                                        ...
                                        <div class="card-footer d-flex justify-content-between">
                                            ...
                                            <button type="submit"
                                                title="{{ $standart->id ? __('Edit') : __('Create') }}"
                                                class="btn {{ $standart->id ? 'btn-warning' : 'btn-primary' }} font-weight-bolder">
                                                <span class="svg-icon svg-icon-md">
                                                    @if($standart->id)
                                                    <span
                                                        class="svg-icon svg-icon-md {{ $standart->id ? 'svg-icon-dark' : '' }}">
                                                ...
                                                <span class="{{ $standart->id ? 'text-dark' : '' }}">
                                                    {{ $standart->id ? __('Edit') : __('Create') }}
                                                </span>
                                            </button>
                                        </div>
                                    </form>
