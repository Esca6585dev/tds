...
<div class="section__profile__body">
    ...
    <div class="section__profile__form">
        ...
        <form action="{{ route('send-application-beyleki-bolumler', app()->getlocale() ) }}" method="post" enctype="multipart/form-data" class="section__container__profile__wrapper">
        @csrf
            ...
            <div class="row">
                <div class="col d-flex">
                    <label>{{ __('Select a section') }}</label>
            ...
            <div class="row">
                <div class="col d-flex">
                    <label>{{ __('Submit selected applications') }}</label>
