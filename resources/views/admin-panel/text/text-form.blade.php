...
@section('title')
{{ __('Texts') }} {{ __( ucfirst(request()->segment(count(request()->segments())))) }}
@endsection
                    ...
                    <div class="d-flex flex-column-fluid">
                        ...
                        <div class="container">
                            ...
                            <div class="card card-custom">
                                ...
                                @if($text->id)
                                <form
                                    action="{{ route(Request::segment(3) . '.update', [ app()->getlocale(), $text->id ] ) }}"
                                    ...
                                    <form
                                                    ...
                                                    <div class="col-4">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" id="exampleSelect1" name="category_id">
                                                                ...
                                                                @foreach($parentCategories as $parenttext)
                                                                <option value="{{ $parenttext->id }}" {{ $parenttext->id == $text->category_id ? 'selected=selected' : '' }}>{{ $parenttext->id }}) {{ $parenttext->{ 'name_' . app()->getlocale() } }}</option>
                                                                @endforeach
                                                            </select>
                                        ...
                                        <div class="card-footer d-flex justify-content-between">
                                            ...
                                            <button type="submit"
                                                title="{{ $text->id ? __('Edit') : __('Create') }}"
                                                class="btn {{ $text->id ? 'btn-warning' : 'btn-primary' }} font-weight-bolder">
                                                <span class="svg-icon svg-icon-md">
                                                    @if($text->id)
                                                    <span class="svg-icon svg-icon-md {{ $text->id ? 'svg-icon-dark' : '' }}">
                                                ...
                                                <span class="{{ $text->id ? 'text-dark' : '' }}">
                                                    {{ $text->id ? __('Edit') : __('Create') }}
                                                </span>
                                            </button>
                                        </div>
                                    </form>
