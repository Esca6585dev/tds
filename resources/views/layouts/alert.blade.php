...
<div class="alert alert-fixed alert-custom alert-secondary fade show mb-5" id="alert-message" role="alert">
    <div class="alert-icon">
        <i class="flaticon-time text-secondary"></i>
    </div>
    <div class="alert-text">{{ __(session()->get('success-restore')) }}</div>
    <div class="alert-close">
        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
            <span aria-hidden="true">
                <i class="ki ki-close"></i>
