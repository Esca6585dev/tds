                                ...
                                <div class="d-flex align-items-baseline flex-wrap mr-5">
                                    ...
                                    <ul
                                        ...
                                        <li class="breadcrumb-item text-muted">
                                            <a href="{{ route('standart.index', [ app()->getlocale() ]) }}" class="text-muted">{{ __('Standards') }}</a>
                                        </li>
                                    </ul>
                                    <!--end::Breadcrumb-->
                                </div>
                            ...
                            <div class="card card-custom">
                                <div class="card-header flex-wrap py-5">
                                    <div class="card-title">
                                        <h3 class="card-label">{{ __('Standards') }}</h3>
                                    </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <!--begin: Datatable-->
                                    @include('admin-panel.standart.standart-table')
                                    <!--end: Datatable-->
                                </div>
                            </div>
                            <!--end::Card-->
