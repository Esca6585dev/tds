...
@section('title')
{{ __('Permissions') }} {{ __( ucfirst(request()->segment(count(request()->segments())))) }}
@endsection
                                ...
                                <div class="d-flex align-items-baseline flex-wrap mr-5">
                                    ...
                                    <ul
                                        ...
                                        <li class="breadcrumb-item text-muted">
                                            <a href="{{ route('permission.index', [ app()->getlocale() ]) }}"
                                                class="text-muted">{{ __('Permissions') }}</a>
                                        </li>
                    ...
                    <div class="d-flex flex-column-fluid">
                        ...
                        <div class="container">
                            ...
                            <div class="card card-custom">
                                ...
                                @if($permission->id)
                                <form
                                    action="{{ route(Request::segment(3) . '.update', [ app()->getlocale(), $permission->id ] ) }}"
                                    ...
                                    <form
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                name="name"
                                                                placeholder="{{ __('Name') }}"
                                                                value="{{ $permission->name ?? '' }}{{ request()->segment(count(request()->segments())) == 'create' ? old('name') : '' }}" />
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                value="{{ $permission->guard_name ?? '' }}{{ request()->segment(count(request()->segments())) == 'create' ? old('name') : '' }}" />
                                        ...
                                        <div class="card-footer d-flex justify-content-between">
                                            ...
                                            <button type="submit"
                                                title="{{ $permission->id ? __('Edit') : __('Create') }}"
                                                class="btn {{ $permission->id ? 'btn-warning' : 'btn-primary' }} font-weight-bolder">
                                                <span class="svg-icon svg-icon-md">
                                                    @if($permission->id)
                                                    <span
                                                        class="svg-icon svg-icon-md {{ $permission->id ? 'svg-icon-dark' : '' }}">
                                                ...
                                                <span class="{{ $permission->id ? 'text-dark' : '' }}">
                                                    {{ $permission->id ? __('Edit') : __('Create') }}
                                                </span>
                                            </button>
                                        </div>
                                    </form>
