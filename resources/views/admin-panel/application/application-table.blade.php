    ...
    <table class="table table-separate table-head-custom table-checkable">
        ...
        <tbody>
            ...
            <tr id="datatable">
                ...
                <td>
                    <span class="badge badge-secondary">{{ \Carbon::parse($application->created_at)->locale(config('app.faker_locales.' . app()->getlocale() ))->isoFormat('LLLL') }}</span>
                </td>
                <td>@include('admin-panel.application.application-action', [ $application ])</td>
            </tr>
            @endforeach
        </tbody>
    </table>
