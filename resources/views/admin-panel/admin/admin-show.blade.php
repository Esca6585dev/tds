                                ...
                                <div class="card-body p-15 pb-20">
                                    <div class="row mb-17">
                                        ...
                                        <div class="col-xxl-7 pl-xxl-11">
                                            <h4 class="font-weight-bolder text-dark mb-7">{{ $admin->first_name }}</h4>
                                            <h4 class="font-weight-bolder text-dark mb-7">{{ $admin->last_name }}</h4>
                                            <h4 class="font-weight-bolder text-dark mb-7">{{ $admin->email }}</h4>
                                            <h4 class="font-weight-bolder text-dark mb-7">{{ $admin->username }}</h4>
                                        </div>
                                    </div>
                                </div>
                                <!--begin::Buttons-->
