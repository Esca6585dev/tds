                                ...
                                <div class="d-flex align-items-baseline flex-wrap mr-5">
                                    ...
                                    <ul
                                        ...
                                        <li class="breadcrumb-item text-muted">
                                            <a href="" class="text-muted">{{ __('Roles') }}</a>
                                        </li>
                                    </ul>
                                    <!--end::Breadcrumb-->
                                </div>
                                ...
                                <div class="card-body p-15 pb-20">
                                    <div class="row mb-17">
                                        ...
                                        <div class="col-xxl-7 pl-xxl-11">
                                            <h4 class="font-weight-bolder text-dark mb-7">{{ $role->name }}</h4>
                                            <h4 class="font-weight-bolder text-dark mb-7">{{ $role->guard_name }}</h4>
                                        </div>
                                    </div>
                                </div>
                                <!--begin::Buttons-->
