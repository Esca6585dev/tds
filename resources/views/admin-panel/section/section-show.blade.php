                                    ...
                                    <div class="row mb-17">
                                        <div class="col-xxl-7 pl-xxl-11">
                                            <h2 class="font-weight-bolder text-dark mb-7" style="font-size: 32px;">
                                                {{ $section->{ 'name_' . app()->getlocale() } }}</h2>
                                            <h5>
                                                <a href="{{ route(Request::segment(4) . '.show', [ app()->getlocale(), $sectionType, $section->parent ? $section->parent->id : $section->id ] ) }}"
                                                    class="{{ $section->parent ? 'text-warning' : 'text-primary' }}">
