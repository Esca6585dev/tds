<span class="dtr-data d-flex">
    <a href="{{ route(Request::segment(4) . '.show', [ app()->getlocale(), $sectionType, $section->id ] ) }}"
    ...
    <a href="{{ route(Request::segment(4) . '.edit', [ app()->getlocale(), $sectionType, $section->id ] ) }}"
    ...
    <form action="{{ route(Request::segment(4) . '.destroy', [ app()->getlocale(), $sectionType, $section->id ] ) }}"
        method="post">
        @method('delete')
        @csrf

        <button type="button" class="btn btn-sm btn-clean btn-icon" title="{{ __('Delete') }}" data-toggle="modal"
            data-target="#exampleModalSizeSm-{{$section->id}}">
        ...
        <div class="example-preview">
            <!--begin::Modal-->
            <div class="modal fade" id="exampleModalSizeSm-{{$section->id}}" tabindex="-1"
                aria-labelledby="exampleModalSizeSm-{{$section->id}}" style="display: none;" aria-hidden="true">
