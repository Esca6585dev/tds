<div class="section__profile">
    <div class="section__profile__wrapper">
        <div class="section__profile__left center-900">
            <div class="section__profile__left__up">
                <div class="section__profile__name">
                    <p>{{ __('Profile') }}</p>
                </div>
            ...
            <div class="section__profile__left__down">
                <ul class="section__profile__menu">
                    <a onclick="showToast()">
                            ...
                            <span class="section__profile__menu__item__icon">
                                <svg width="18px" height="18px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                    ...
                                    <g id="Stockholm-icons-/-Navigation-/-Sign-out" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                        ...
                                        <rect id="Rectangle" fill="#000000" opacity="0.3" transform="translate(14.000000, 12.000000) rotate(-270.000000) translate(-14.000000, -12.000000) " x="13" y="6" width="2" height="12" rx="1"></rect>
                        ...
                        <form action="{{ route('logout', app()->getlocale() ) }}" method="post" class="hide" id="logout__form">
                            @csrf
                            <input type="hidden">
                        </form>
