...
@section('title')
{{ __('News') }} {{ __( ucfirst(request()->segment(count(request()->segments())))) }}
@endsection
                                ...
                                <div class="d-flex align-items-baseline flex-wrap mr-5">
                                    ...
                                    <ul
                                        ...
                                        <li class="breadcrumb-item text-muted">
                                            <a href="{{ route('text.index', [ app()->getlocale(), 'all' ]) }}"
                                                class="text-muted">{{ __('News') }}</a>
                                        </li>

                                        <li class="breadcrumb-item text-muted">
                                            <a href="{{ route('text.index', [ app()->getlocale() ]) }}"
                                                class="text-muted">
                                                {{ __('News') }}
                                            </a>
                                        </li>
                    ...
                    <div class="d-flex flex-column-fluid">
                        ...
                        <div class="container">
                            ...
                            <div class="card card-custom">
                                ...
                                @if($news->id)
                                <form
                                    action="{{ route(Request::segment(3) . '.update', [ app()->getlocale(), $news->id ] ) }}"
                                    ...
                                    <form
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                value="{{ $news->{ 'name_' . $lang } ?? '' }}{{ request()->segment(count(request()->segments())) == 'create' ? old('name_' . $lang) : '' }}" />
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="summernote @error('text_' . $lang ) is-invalid @enderror" id="kt_summernote_1" name="text_{{ $lang }}" >{{ $news->{ 'text_' . $lang } ?? '' }}{{ request()->segment(count(request()->segments())) == 'create' ? old('text_' . $lang) : '' }}</textarea>
                                                    ...
                                                    <div class="col-3">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" id="exampleSelect1" name="category_id">
                                                                <option value="1" {{ 1 == $news->category_id ? 'selected=selected' : '' }}>{{ __('News') }}</option>
                                                                <option value="2" {{ 2 == $news->category_id ? 'selected=selected' : '' }}>{{ __('Work in progress') }}</option>
                                                                <option value="3" {{ 3 == $news->category_id ? 'selected=selected' : '' }}>{{ __('Web-site') }}</option>
                                                            </select>
                                                    ...
                                                    <div class="col-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control @error('view') is-invalid @enderror" name="view" value="{{ $news->view }}{{ request()->segment(count(request()->segments())) == 'create' ? old('view') : '' }}" >
                                                    ...
                                                    <div class="col-3">
                                                        <div class="form-group">
                                                            <label>{{ __('Created time') }}</label>

                                                            <input type="date" value="{{ Carbon::parse($news->created_at)->format('Y-m-d') }}"
                                                    ...
                                                    <div class="col-12">
                                                        <div class="image-input image-input-outline"
                                                            ...
                                                            <div class="image-input-wrapper"
                                                                style="background-image: url({{ asset($news->image) }}); width: 300px; height: 200px">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    @endif
                                        ...
                                        <div class="card-footer d-flex justify-content-between">
                                            ...
                                            <button type="submit"
                                                title="{{ $news->id ? __('Edit') : __('Create') }}"
                                                class="btn {{ $news->id ? 'btn-warning' : 'btn-primary' }} font-weight-bolder">
                                                <span class="svg-icon svg-icon-md">
                                                    @if($news->id)
                                                    <span class="svg-icon svg-icon-md {{ $news->id ? 'svg-icon-dark' : '' }}">
