...
@section('title')
{{ __('Magazine') }} {{ __( ucfirst(request()->segment(count(request()->segments())))) }}
@endsection
                                    ...
                                    <ul
                                        ...
                                        <li class="breadcrumb-item text-muted">
                                            <a href="{{ route('text.index', [ app()->getlocale(), 'all' ]) }}"
                                                class="text-muted">{{ __('Magazine') }}</a>
                                        </li>
                            ...
                            <div class="card card-custom">
                                <div class="card-header flex-wrap py-5">
                                    <div class="card-title">
                                        <h3 class="card-label">{{ __('Magazine') }}
                                ...
                                @if($magazine->id)
                                <form
                                    action="{{ route(Request::segment(3) . '.update', [ app()->getlocale(), $magazine->id ] ) }}"
                                    ...
                                    <form
                                                    ...
                                                    <div class="col-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                name="name"
                                                                placeholder="{{ __('Name') }}"
                                                                value="{{ $magazine->name ?? '' }}{{ request()->segment(count(request()->segments())) == 'create' ? old('name') : '' }}" />
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                placeholder="{{ __('Url') }}"
                                                                value="{{ $magazine->url ?? '' }}{{ request()->segment(count(request()->segments())) == 'create' ? old('url') : '' }}" readonly />
                                        ...
                                        <div class="card-footer d-flex justify-content-between">
                                            ...
                                            <button type="submit"
                                                title="{{ $magazine->id ? __('Edit') : __('Create') }}"
                                                class="btn {{ $magazine->id ? 'btn-warning' : 'btn-primary' }} font-weight-bolder">
                                                <span class="svg-icon svg-icon-md">
                                                    @if($magazine->id)
                                                    <span class="svg-icon svg-icon-md {{ $magazine->id ? 'svg-icon-dark' : '' }}">
                                                ...
                                                <span class="{{ $magazine->id ? 'text-dark' : '' }}">
                                                    {{ $magazine->id ? __('Edit') : __('Create') }}
                                                </span>
                                            </button>
                                        </div>
                                    </form>
