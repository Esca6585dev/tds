                                ...
                                <div class="card-body p-15 pb-20">
                                    <div class="row mb-17">
                                        <div class="col-xxl-5 mb-11 mb-xxl-0">
                                            ...
                                            <div class="card card-custom card-stretch">
                                                <div class="card-body p-0 rounded px-10 py-15 d-flex align-items-center justify-content-center">
                                                    <h1>
                                                        <a href="/{{ $standart->file }}" target="_blank">
                                                            {{ $standart->number }}
                                                        </a>
                                                    </h1>
                                                </div>
                                        ...
                                        <div class="col-xxl-7 pl-xxl-11">
                                            <h4 class="font-weight-bolder text-dark mb-7">{{ $standart->name_tm }}</h4>
                                            <h4 class="font-weight-bolder text-dark mb-7">{{ $standart->name_en }}</h4>
                                            <h4 class="font-weight-bolder text-dark mb-7">{{ $standart->name_ru }}</h4>
                                        </div>
                                    </div>
                                </div>
                                <!--begin::Buttons-->
