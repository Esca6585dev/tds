                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                value="{{ $admin->email ?? '' }}{{ request()->segment(count(request()->segments())) == 'create' ? old('email') : '' }}" />
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select name="roles" id="" class="form-control @error('roles') is-invalid @enderror">
                                                                @foreach ($roles as $role)
                                                                    <option value="{{ $role }}" {{ $admin->id ? ($admin->roles->pluck('name')->first() == $role) ? 'selected=selected' : '' : '' }} >{{ $role }}</option>
                                                                @endforeach
                                                            </select>
