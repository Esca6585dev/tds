<span class="dtr-data d-flex">
    <a href="{{ route(Request::segment(3) . '.show', [ app()->getlocale(), $magazine->id ] ) }}"
    ...
    <a href="{{ route(Request::segment(3) . '.edit', [ app()->getlocale(), $magazine->id ] ) }}"
    ...
    <form action="{{ route(Request::segment(3) . '.destroy', [ app()->getlocale(), $magazine->id ] ) }}"
        method="post">
        @method('delete')
        @csrf

        <button type="button" class="btn btn-sm btn-clean btn-icon" title="{{ __('Delete') }}" data-toggle="modal"
            data-target="#exampleModalSizeSm-{{$magazine->id}}">
        ...
        <div class="example-preview">
            <!--begin::Modal-->
            <div class="modal fade" id="exampleModalSizeSm-{{$magazine->id}}" tabindex="-1"
                aria-labelledby="exampleModalSizeSm-{{$magazine->id}}" style="display: none;" aria-hidden="true">
