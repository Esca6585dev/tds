                                ...
                                <div class="card-body p-15 pb-20">
                                    <div class="row mb-17">
                                        ...
                                        <div class="col-xxl-7 pl-xxl-11">
                                            <h4 class="font-weight-bolder text-dark mb-7">{{ __('First Name') }}: {{ $application->user->first_name }}</h4>
                                            <h4 class="font-weight-bolder text-dark mb-7">{{ __('Last Name') }}: {{ $application->user->last_name }}</h4>
                                            <h4 class="font-weight-bolder text-dark mb-7">{{ __('Phone number') }}: {{ $application->user->phone_number }}</h4>
                                            <h4 class="font-weight-bolder text-dark mb-7">{{ __('IP Address') }}: {{ $application->ip_address }}</h4>
                                            <h4 class="font-weight-bolder text-dark mb-7">{{ __('Deleted time') }}:
                                                <i>
                                                    <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                                ...
                                                <span class="badge badge-danger">{{ $application->deleted_at  }}</span>
                                            </h4>
                                        </div>
                                    </div>
                                </div>
